...
class AudioController {
    constructor() {
        this.bgMusic = new Audio('../Memory/media/Travel.mp3');
        this.flipSound = new Audio('../Memory/media/flip.wav');
        this.matchSound = new Audio('../Memory/media/match.wav');
        this.victorySound = new Audio('../Memory/media/victory.mp3');
        this.gameOverSound = new Audio('../Memory/media/gameOver.wav');
...
// flipcards
    getCardType(card) {
        return card.getElementsByClassName('city')[0].src;
    }
    canFlipCard(card) {
